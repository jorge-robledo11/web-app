...
down_revision: Union[str, Sequence[str], None] = '001_bootstrap'
...
def upgrade() -> None:
    ...
    sa.Column('estado', sa.Enum('disponible', 'rentada', 'mantenimiento', 'inactiva', name='estado_propiedad'), nullable=False),
    sa.Column('imagen', sa.String(length=512), nullable=False),
    sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), nullable=False),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('titulo', 'direccion', 'ciudad', name='uq_propiedades_identidad_negocio'),
    ...
    op.create_index('ix_propiedades_precio_mensual', 'propiedades', ['precio_mensual'], unique=False)
