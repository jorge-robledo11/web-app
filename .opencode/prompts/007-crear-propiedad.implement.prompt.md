---
name: 007-crear-propiedad-implement
description: >
  Implementa 007-crear-propiedad siguiendo tasks.md.
spec_kit_command: "/speckit.implement"
usage: "/speckit.implement @.opencode/prompts/007-crear-propiedad.implement.prompt.md"
...
Implementa `007-crear-propiedad` siguiendo `tasks.md` en orden,
...
* Branch `007-crear-propiedad` activo.
...
* No crear endpoints adicionales fuera de `GET /propiedades/nueva` y
  `POST /propiedades`.
* No introducir dependencias nuevas.
* No modificar modelos de datos.
* No crear módulos de rentas, pagos ni contratos.
* No implementar edición ni eliminación de propiedades.
...
```
Feature implementada: 007-crear-propiedad
Tests: N pasados
Cobertura: X%
```
